...
[purificator.anyDamage().onlyDamageAtMost(127).marked("mark").transformDamage().reuse(),<additions:srpcustom-pest_diamond>],
function(out, ins, cInfo){
	  return out;
  }, 
null);
recipes.addShapeless("e",<minecraft:emerald>,
[purificator.anyDamage().onlyDamageAtMost(127).marked("mark").transformDamage().reuse(),<additions:srpcustom-pest_emerald>],
function(out, ins, cInfo){
	  return out;
  }, 
null);
recipes.addShapeless("i",<minecraft:iron_ingot>,
[purificator.anyDamage().onlyDamageAtMost(127).marked("mark").transformDamage().reuse(),<additions:srpcustom-pest_iron>],
function(out, ins, cInfo){
	  return out;
  }, 
null);
recipes.addShapeless("g",<minecraft:gold_ingot>,
[purificator.anyDamage().onlyDamageAtMost(127).marked("mark").transformDamage().reuse(),<additions:srpcustom-pest_gold>],
function(out, ins, cInfo){
	  return out;
}, 
null);
recipes.addShapeless("r",<minecraft:redstone>,
[purificator.anyDamage().onlyDamageAtMost(127).marked("mark").transformDamage().reuse(),<additions:srpcustom-pest_redstone>],
function(out, ins, cInfo){
	  return out;
  }, 
null);
recipes.addShapeless("c",<minecraft:coal>,
[purificator.anyDamage().onlyDamageAtMost(127).marked("mark").transformDamage().reuse(),<additions:srpcustom-pest_coal>],
function(out, ins, cInfo){
	  return out;
  }, 
null);
recipes.addShapeless("l",<minecraft:dye:4>,
[purificator.anyDamage().onlyDamageAtMost(127).marked("mark").transformDamage().reuse(),<additions:srpcustom-pest_lplz>],
function(out, ins, cInfo){
	  return out;
  }, 
null);